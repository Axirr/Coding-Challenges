...
class Node:
    ...
    def addChild(self, newChildNode):
        self.childrenList.append(newChildNode)
...
class Solution:
    def findAllConcatenatedWordsInADict(self, words: List[str]) -> List[str]:
        ...
        for i in range(len(words) - 1, -1, -1):
            ...
            if self.isWordConcatendated(currentWord, wordMap):
                ...
                tempBaseWords.append(currentWord)
    ...
    def addWordToWordMap(self, rootList, newWord):
        ...
        for i in range(len(newWord)):
            ...
            currentChildren = currentParent.childrenList
